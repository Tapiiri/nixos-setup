{pkgs, ...}: {
  ...
  git-hooks.hooks = {
    nix-flake-check = {
      ...
      entry = "scripts/ensure-lpass-login -- devenv tasks run check:nix:flake";
      language = "system";
    ...
    alejandra-fmt = {
      ...
      entry = "scripts/ensure-lpass-login -- devenv tasks run fmt:nix:alejandra";
      language = "system";
    ...
    yamllint = {
      enable = true;
      name = "yamllint";
      entry = "scripts/ensure-lpass-login -- devenv tasks run lint:yaml:yamllint";
      language = "system";
      files = ".*\\.ya?ml$";
      pass_filenames = false;
    };
    ...
    actionlint = {
      enable = true;
      name = "actionlint";
      entry = "scripts/ensure-lpass-login -- devenv tasks run lint:gha:actionlint";
      language = "system";
    ...
    shellcheck = {
      enable = true;
      name = "shellcheck";
      entry = "scripts/ensure-lpass-login -- devenv tasks run lint:shell:shellcheck";
      language = "system";
    ...
    markdownlint = {
      enable = true;
      name = "markdownlint";
      entry = "scripts/ensure-lpass-login -- devenv tasks run lint:md:markdownlint";
      language = "system";
      files = ".*\\.md$";
      pass_filenames = false;
    };
    ...
    ruff-check = {
      enable = true;
      name = "ruff check";
      entry = "scripts/ensure-lpass-login -- devenv tasks run lint:python:ruff";
      language = "system";
      pass_filenames = false;
    };
    ...
    python-pytest = {
      enable = true;
      name = "pytest";
      entry = "scripts/ensure-lpass-login -- devenv tasks run tests:python:pytest";
      language = "system";
      pass_filenames = false;
    };
  };
